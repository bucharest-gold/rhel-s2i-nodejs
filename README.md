...
[![Build Status](https://travis-ci.org/bucharest-gold/rhel7-s2i-nodejs.svg?branch=master)](https://travis-ci.org/bucharest-gold/rhel7-s2i-nodejs)
[![](https://images.microbadger.com/badges/image/bucharestgold/rhel7-s2i-nodejs.svg)](https://microbadger.com/images/bucharestgold/rhel7-s2i-nodejs "Get your own image badge on microbadger.com")
...
[![docker hub stats](http://dockeri.co/image/bucharestgold/rhel7-s2i-nodejs)](https://hub.docker.com/r/bucharestgold/rhel7-s2i-nodejs/)
...
The [`oc` command-line tool](https://github.com/openshift/origin/releases) can be used to start a build, layering your desired nodejs `REPO_URL` sources into a rhel7 image with your selected `RELEASE` of Node.js via the following command format:
...
To replace [the default SCL-packaged `openshift/nodejs` image](https://hub.docker.com/r/openshift/nodejs-010-rhel7/) (admin access required), run:
